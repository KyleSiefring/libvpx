    ...
    for (column_start = 0; column_start < 32; column_start += 8) {
      ...
      if (pass == 0) {
        ...
        }
        {
          ...
          out[0] = _mm_packs_epi32(out_00_6, out_08_6);
          out[16] = _mm_packs_epi32(out_00_7, out_08_7);
          out[8] = _mm_packs_epi32(out_16_6, out_24_6);
          out[24] = _mm_packs_epi32(out_16_7, out_24_7);
#if DCT_HIGH_BIT_DEPTH
          overflow =
        ...
        // Stage 6
        {
          ...
          // Combine out of order to begin transposing
          out[4] = _mm_packs_epi32(out_04_6, out_12_6);
          out[20] = _mm_packs_epi32(out_04_7, out_12_7);
          out[12] = _mm_packs_epi32(out_20_6, out_28_6);
          out[28] = _mm_packs_epi32(out_20_7, out_28_7);
#if DCT_HIGH_BIT_DEPTH
          overflow =
        ...
        // Stage 7
        {
          ...
          // Combine out of order to begin transposing
          out[2] = _mm_packs_epi32(out_02_6, out_10_6);
          out[18] = _mm_packs_epi32(out_02_7, out_10_7);
          out[10] = _mm_packs_epi32(out_18_6, out_26_6);
          out[26] = _mm_packs_epi32(out_18_7, out_26_7);
          out[6] = _mm_packs_epi32(out_06_6, out_14_6);
          out[22] = _mm_packs_epi32(out_06_7, out_14_7);
          out[14] = _mm_packs_epi32(out_22_6, out_30_6);
          out[30] = _mm_packs_epi32(out_22_7, out_30_7);
#if DCT_HIGH_BIT_DEPTH
          overflow =
        ...
        // Final stage --- outputs indices are bit-reversed.
        {
          ...
          // Combine out of order to begin transposing
          out[1] = _mm_packs_epi32(out_01_6, out_09_6);
          out[17] = _mm_packs_epi32(out_01_7, out_09_7);
          out[9] = _mm_packs_epi32(out_17_6, out_25_6);
          out[25] = _mm_packs_epi32(out_17_7, out_25_7);
          out[7] = _mm_packs_epi32(out_07_6, out_15_6);
          out[23] = _mm_packs_epi32(out_07_7, out_15_7);
          out[15] = _mm_packs_epi32(out_23_6, out_31_6);
          out[31] = _mm_packs_epi32(out_23_7, out_31_7);
#if DCT_HIGH_BIT_DEPTH
          overflow =
        ...
        }
        {
          ...
          // Combine out of order to begin transposing
          out[5] = _mm_packs_epi32(out_05_6, out_13_6);
          out[21] = _mm_packs_epi32(out_05_7, out_13_7);
          out[13] = _mm_packs_epi32(out_21_6, out_29_6);
          out[29] = _mm_packs_epi32(out_21_7, out_29_7);
          out[3] = _mm_packs_epi32(out_03_6, out_11_6);
          out[19] = _mm_packs_epi32(out_03_7, out_11_7);
          out[11] = _mm_packs_epi32(out_19_6, out_27_6);
          out[27] = _mm_packs_epi32(out_19_7, out_27_7);
#if DCT_HIGH_BIT_DEPTH
          overflow =
        ...
        // stage 3
        {
          ...
          u[0] = _mm_unpacklo_epi16(step2[0], step2[7]);
          u[1] = _mm_unpackhi_epi16(step2[0], step2[7]);
          u[2] = _mm_unpacklo_epi16(step2[1], step2[6]);
          u[3] = _mm_unpackhi_epi16(step2[1], step2[6]);
          u[4] = _mm_unpacklo_epi16(step2[2], step2[5]);
          u[5] = _mm_unpackhi_epi16(step2[2], step2[5]);
          u[6] = _mm_unpacklo_epi16(step2[3], step2[4]);
          u[7] = _mm_unpackhi_epi16(step2[3], step2[4]);

          step3[0] = _mm_madd_epi16(u[0], kOne);
          hi[0] = _mm_madd_epi16(u[1], kOne);
          step3[1] = _mm_madd_epi16(u[2], kOne);
          hi[1] = _mm_madd_epi16(u[3], kOne);
          step3[2] = _mm_madd_epi16(u[4], kOne);
          hi[2] = _mm_madd_epi16(u[5], kOne);
          step3[3] = _mm_madd_epi16(u[6], kOne);
          hi[3] = _mm_madd_epi16(u[7], kOne);

          step3[4] = _mm_madd_epi16(u[6], k__pOne_mOne);
          hi[4] = _mm_madd_epi16(u[7], k__pOne_mOne);
          step3[5] = _mm_madd_epi16(u[4], k__pOne_mOne);
          hi[5] = _mm_madd_epi16(u[5], k__pOne_mOne);
          step3[6] = _mm_madd_epi16(u[2], k__pOne_mOne);
          hi[6] = _mm_madd_epi16(u[3], k__pOne_mOne);
          step3[7] = _mm_madd_epi16(u[0], k__pOne_mOne);
          hi[7] = _mm_madd_epi16(u[1], k__pOne_mOne);
        }
        {
          const __m128i s3_10_0 = _mm_unpacklo_epi16(step2[13], step2[10]);
          const __m128i s3_10_1 = _mm_unpackhi_epi16(step2[13], step2[10]);
          ...
          const __m128i s3_13_3 = _mm_madd_epi16(s3_10_1, k__cospi_p16_p16);
          // dct_const_round_shift
          const __m128i s3_10_4 =
              _mm_add_epi32(s3_10_2, k__DCT_CONST_ROUNDING);
          const __m128i s3_10_5 =
              _mm_add_epi32(s3_10_3, k__DCT_CONST_ROUNDING);
          const __m128i s3_11_4 =
              _mm_add_epi32(s3_11_2, k__DCT_CONST_ROUNDING);
          const __m128i s3_11_5 =
              _mm_add_epi32(s3_11_3, k__DCT_CONST_ROUNDING);
          const __m128i s3_12_4 =
              _mm_add_epi32(s3_12_2, k__DCT_CONST_ROUNDING);
          const __m128i s3_12_5 =
              _mm_add_epi32(s3_12_3, k__DCT_CONST_ROUNDING);
          const __m128i s3_13_4 =
              _mm_add_epi32(s3_13_2, k__DCT_CONST_ROUNDING);
          const __m128i s3_13_5 =
              _mm_add_epi32(s3_13_3, k__DCT_CONST_ROUNDING);
          step3[10] = _mm_srai_epi32(s3_10_4, DCT_CONST_BITS);
          hi[10] = _mm_srai_epi32(s3_10_5, DCT_CONST_BITS);
          step3[11] = _mm_srai_epi32(s3_11_4, DCT_CONST_BITS);
          hi[11] = _mm_srai_epi32(s3_11_5, DCT_CONST_BITS);
          step3[12] = _mm_srai_epi32(s3_12_4, DCT_CONST_BITS);
          hi[12] = _mm_srai_epi32(s3_12_5, DCT_CONST_BITS);
          step3[13] = _mm_srai_epi32(s3_13_4, DCT_CONST_BITS);
          hi[13] = _mm_srai_epi32(s3_13_5, DCT_CONST_BITS);
        }
        {
          u[0] = _mm_unpacklo_epi16(step1[16], step2[23]);
          u[1] = _mm_unpackhi_epi16(step1[16], step2[23]);
          u[2] = _mm_unpacklo_epi16(step1[17], step2[22]);
          u[3] = _mm_unpackhi_epi16(step1[17], step2[22]);
          u[4] = _mm_unpacklo_epi16(step1[18], step2[21]);
          u[5] = _mm_unpackhi_epi16(step1[18], step2[21]);
          u[6] = _mm_unpacklo_epi16(step1[19], step2[20]);
          u[7] = _mm_unpackhi_epi16(step1[19], step2[20]);

          u[8] = _mm_unpacklo_epi16(step1[28], step2[27]);
          u[9] = _mm_unpackhi_epi16(step1[28], step2[27]);
          u[10] = _mm_unpacklo_epi16(step1[29], step2[26]);
          u[11] = _mm_unpackhi_epi16(step1[29], step2[26]);
          u[12] = _mm_unpacklo_epi16(step1[30], step2[25]);
          u[13] = _mm_unpackhi_epi16(step1[30], step2[25]);
          u[14] = _mm_unpacklo_epi16(step1[31], step2[24]);
          u[15] = _mm_unpackhi_epi16(step1[31], step2[24]);

          step3[16] = _mm_madd_epi16(u[0], kOne);
          hi[16] = _mm_madd_epi16(u[1], kOne);
          step3[17] = _mm_madd_epi16(u[2], kOne);
          hi[17] = _mm_madd_epi16(u[3], kOne);
          step3[18] = _mm_madd_epi16(u[4], kOne);
          hi[18] = _mm_madd_epi16(u[5], kOne);
          step3[19] = _mm_madd_epi16(u[6], kOne);
          hi[19] = _mm_madd_epi16(u[7], kOne);

          step3[20] = _mm_madd_epi16(u[6], k__pOne_mOne);
          hi[20] = _mm_madd_epi16(u[7], k__pOne_mOne);
          step3[21] = _mm_madd_epi16(u[4], k__pOne_mOne);
          hi[21] = _mm_madd_epi16(u[5], k__pOne_mOne);
          step3[22] = _mm_madd_epi16(u[2], k__pOne_mOne);
          hi[22] = _mm_madd_epi16(u[3], k__pOne_mOne);
          step3[23] = _mm_madd_epi16(u[0], k__pOne_mOne);
          hi[23] = _mm_madd_epi16(u[1], k__pOne_mOne);

          step3[24] = _mm_madd_epi16(u[14], k__pOne_mOne);
          hi[24] = _mm_madd_epi16(u[15], k__pOne_mOne);
          step3[25] = _mm_madd_epi16(u[12], k__pOne_mOne);
          hi[25] = _mm_madd_epi16(u[13], k__pOne_mOne);
          step3[26] = _mm_madd_epi16(u[10], k__pOne_mOne);
          hi[26] = _mm_madd_epi16(u[11], k__pOne_mOne);
          step3[27] = _mm_madd_epi16(u[8], k__pOne_mOne);
          hi[27] = _mm_madd_epi16(u[9], k__pOne_mOne);

          step3[28] = _mm_madd_epi16(u[8], kOne);
          hi[28] = _mm_madd_epi16(u[9], kOne);
          step3[29] = _mm_madd_epi16(u[10], kOne);
          hi[29] = _mm_madd_epi16(u[11], kOne);
          step3[30] = _mm_madd_epi16(u[12], kOne);
          hi[30] = _mm_madd_epi16(u[13], kOne);
          step3[31] = _mm_madd_epi16(u[14], kOne);
          hi[31] = _mm_madd_epi16(u[15], kOne);
        }
        ...
        // stage 4
        {
          ...
          u[0] = _mm_unpacklo_epi16(step2[8], sign[0]);
          hi[8] = _mm_unpackhi_epi16(step2[8], sign[0]);
          u[1] = _mm_unpacklo_epi16(step2[9], sign[1]);
          hi[9] = _mm_unpackhi_epi16(step2[9], sign[1]);
          u[2] = _mm_unpacklo_epi16(step2[14], sign[2]);
          hi[14] = _mm_unpackhi_epi16(step2[14], sign[2]);
          u[3] = _mm_unpacklo_epi16(step2[15], sign[3]);
          hi[15] = _mm_unpackhi_epi16(step2[15], sign[3]);
          step2[8] = u[0];
          step2[9] = u[1];
          step2[14] = u[2];
          step2[15] = u[3];
        ...
        // stage 4
        {
          step1[0] = _mm_add_epi32(step3[3], step3[0]);
          step1[1] = _mm_add_epi32(step3[2], step3[1]);
          step1[2] = _mm_sub_epi32(step3[1], step3[2]);
          step1[3] = _mm_sub_epi32(step3[0], step3[3]);

          step1[8] = _mm_add_epi32(step3[11], step2[8]);
          step1[9] = _mm_add_epi32(step3[10], step2[9]);
          step1[10] = _mm_sub_epi32(step2[9], step3[10]);
          step1[11] = _mm_sub_epi32(step2[8], step3[11]);
          step1[12] = _mm_sub_epi32(step2[15], step3[12]);
          step1[13] = _mm_sub_epi32(step2[14], step3[13]);
          step1[14] = _mm_add_epi32(step3[13], step2[14]);
          step1[15] = _mm_add_epi32(step3[12], step2[15]);
        }
        {
          // to be continued...
          //
          ...
          step1[5] = _mm_srai_epi32(v[0], DCT_CONST_BITS);
          step1[6] = _mm_srai_epi32(v[1], DCT_CONST_BITS);
        }
        {
          ...
          const __m128i k32_p24_p08 =
              pair_set_epi32(cospi_24_64, cospi_8_64);

          u[0] = _mm_unpacklo_epi32(step3[18], step3[29]);
          u[1] = _mm_unpackhi_epi32(step3[18], step3[29]);
          u[2] = _mm_unpacklo_epi32(step3[19], step3[28]);
          u[3] = _mm_unpackhi_epi32(step3[19], step3[28]);
          u[4] = _mm_unpacklo_epi32(step3[20], step3[27]);
          u[5] = _mm_unpackhi_epi32(step3[20], step3[27]);
          u[6] = _mm_unpacklo_epi32(step3[21], step3[26]);
          u[7] = _mm_unpackhi_epi32(step3[21], step3[26]);
          ...
          v[8] = k_madd_epi32(u[6], k32_m08_p24);
          v[9] = k_madd_epi32(u[7], k32_m08_p24);
          v[10] = k_madd_epi32(u[4], k32_m08_p24);
          v[11] = k_madd_epi32(u[5], k32_m08_p24);
          v[12] = k_madd_epi32(u[2], k32_p24_p08);
          v[13] = k_madd_epi32(u[3], k32_p24_p08);
          v[14] = k_madd_epi32(u[0], k32_p24_p08);
          v[15] = k_madd_epi32(u[1], k32_p24_p08);
#if DCT_HIGH_BIT_DEPTH
          ...
          step1[18] = _mm_srai_epi32(v[0], DCT_CONST_BITS);
          step1[19] = _mm_srai_epi32(v[1], DCT_CONST_BITS);
          step1[20] = _mm_srai_epi32(v[2], DCT_CONST_BITS);
          step1[21] = _mm_srai_epi32(v[3], DCT_CONST_BITS);
          step1[26] = _mm_srai_epi32(v[4], DCT_CONST_BITS);
          step1[27] = _mm_srai_epi32(v[5], DCT_CONST_BITS);
          step1[28] = _mm_srai_epi32(v[6], DCT_CONST_BITS);
          step1[29] = _mm_srai_epi32(v[7], DCT_CONST_BITS);
        }
        // stage 5
        {
          step2[4] = _mm_add_epi32(step1[5], step3[4]);
          step2[5] = _mm_sub_epi32(step3[4], step1[5]);
          step2[6] = _mm_sub_epi32(step3[7], step1[6]);
        ...
        }
        {
          ...
          u[0] = _mm_unpacklo_epi32(step1[0], step1[1]);
          u[1] = _mm_unpackhi_epi32(step1[0], step1[1]);
          u[2] = _mm_unpacklo_epi32(step1[2], step1[3]);
          u[3] = _mm_unpackhi_epi32(step1[2], step1[3]);

          // TODO(jingning): manually inline k_madd_epi32_ to further hide
          // instruction latency.
          v[0] = k_madd_epi32(u[0], k32_p16_p16);
          v[1] = k_madd_epi32(u[1], k32_p16_p16);
          v[2] = k_madd_epi32(u[0], k32_p16_m16);
          v[3] = k_madd_epi32(u[1], k32_p16_m16);
          v[4] = k_madd_epi32(u[2], k32_p24_p08);
          v[5] = k_madd_epi32(u[3], k32_p24_p08);
          v[6] = k_madd_epi32(u[2], k32_m08_p24);
          v[7] = k_madd_epi32(u[3], k32_m08_p24);
#if DCT_HIGH_BIT_DEPTH
          ...
          sign[0] = _mm_cmpgt_epi32(kZero, u[0]);
          sign[1] = _mm_cmpgt_epi32(kZero, u[1]);
          sign[2] = _mm_cmpgt_epi32(kZero, u[2]);
          sign[3] = _mm_cmpgt_epi32(kZero, u[3]);
          ...
          // Combine out of order to begin transposing
          out_ptr[0] = _mm_packs_epi32(u[0], u[2]);
          out_ptr[8] = _mm_packs_epi32(u[1], u[3]);
#if DCT_HIGH_BIT_DEPTH
          overflow =
              check_epi16_overflow_x2(&out_ptr[0], &out_ptr[8]);
          if (overflow) {
            HIGH_FDCT32x32_2D_ROWS_C(intermediate, output_org);
            return;
          }
        ...
        }
        {
          ...
          u[0] = _mm_unpacklo_epi32(step1[9], step1[14]);
          u[1] = _mm_unpackhi_epi32(step1[9], step1[14]);
          u[2] = _mm_unpacklo_epi32(step1[10], step1[13]);
          u[3] = _mm_unpackhi_epi32(step1[10], step1[13]);

          v[0] = k_madd_epi32(u[0], k32_m08_p24);
          v[1] = k_madd_epi32(u[1], k32_m08_p24);
          v[2] = k_madd_epi32(u[2], k32_m24_m08);
          v[3] = k_madd_epi32(u[3], k32_m24_m08);
          v[4] = k_madd_epi32(u[2], k32_m08_p24);
          v[5] = k_madd_epi32(u[3], k32_m08_p24);
          v[6] = k_madd_epi32(u[0], k32_p24_p08);
          v[7] = k_madd_epi32(u[1], k32_p24_p08);
#if DCT_HIGH_BIT_DEPTH
          overflow = k_check_epi32_overflow_8(&v[0], &v[1], &v[2], &v[3], &v[4],
                                              &v[5], &v[6], &v[7], &kZero);
          if (overflow) {
          ...
          step2[9] = _mm_srai_epi32(u[0], DCT_CONST_BITS);
          step2[10] = _mm_srai_epi32(u[1], DCT_CONST_BITS);
          step2[13] = _mm_srai_epi32(u[2], DCT_CONST_BITS);
          step2[14] = _mm_srai_epi32(u[3], DCT_CONST_BITS);
        }
        {
          step2[16] = _mm_add_epi32(step1[19], step3[16]);
          step2[17] = _mm_add_epi32(step1[18], step3[17]);
          step2[18] = _mm_sub_epi32(step3[17], step1[18]);
          step2[19] = _mm_sub_epi32(step3[16], step1[19]);
          step2[20] = _mm_sub_epi32(step3[23], step1[20]);
          step2[21] = _mm_sub_epi32(step3[22], step1[21]);
          step2[22] = _mm_add_epi32(step1[21], step3[22]);
          step2[23] = _mm_add_epi32(step1[20], step3[23]);
          step2[24] = _mm_add_epi32(step1[27], step3[24]);
          step2[25] = _mm_add_epi32(step1[26], step3[25]);
          step2[26] = _mm_sub_epi32(step3[25], step1[26]);
          step2[27] = _mm_sub_epi32(step3[24], step1[27]);
          step2[28] = _mm_sub_epi32(step3[31], step1[28]);
          step2[29] = _mm_sub_epi32(step3[30], step1[29]);
          step2[30] = _mm_add_epi32(step1[29], step3[30]);
          step2[31] = _mm_add_epi32(step1[28], step3[31]);
        }
        // stage 6
        {
          const __m128i k32_p28_p04 =
          ...
          u[0] = _mm_unpacklo_epi32(step2[4], step2[7]);
          u[1] = _mm_unpackhi_epi32(step2[4], step2[7]);
          u[2] = _mm_unpacklo_epi32(step2[5], step2[6]);
          u[3] = _mm_unpackhi_epi32(step2[5], step2[6]);

          v[0] = k_madd_epi32(u[0], k32_p28_p04);
          v[1] = k_madd_epi32(u[1], k32_p28_p04);
          v[2] = k_madd_epi32(u[2], k32_p12_p20);
          v[3] = k_madd_epi32(u[3], k32_p12_p20);
          v[4] = k_madd_epi32(u[2], k32_m20_p12);
          v[5] = k_madd_epi32(u[3], k32_m20_p12);
          v[6] = k_madd_epi32(u[0], k32_m04_p28);
          v[7] = k_madd_epi32(u[1], k32_m04_p28);
#if DCT_HIGH_BIT_DEPTH
          overflow = k_check_epi32_overflow_8(&v[0], &v[1], &v[2], &v[3], &v[4],
                                              &v[5], &v[6], &v[7], &kZero);
          if (overflow) {
          ...
          out_ptr[4] = _mm_packs_epi32(u[0], u[2]);
          out_ptr[12] = _mm_packs_epi32(u[1], u[3]);
#if DCT_HIGH_BIT_DEPTH
          overflow =
              check_epi16_overflow_x2(&out_ptr[4], &out_ptr[12]);
          if (overflow) {
            HIGH_FDCT32x32_2D_ROWS_C(intermediate, output_org);
            return;
          }
        ...
        {
          step3[8] = _mm_add_epi32(step2[9], step1[8]);
          step3[9] = _mm_sub_epi32(step1[8], step2[9]);
          step3[10] = _mm_sub_epi32(step1[11], step2[10]);
          step3[11] = _mm_add_epi32(step2[10], step1[11]);
          step3[12] = _mm_add_epi32(step2[13], step1[12]);
          step3[13] = _mm_sub_epi32(step1[12], step2[13]);
          step3[14] = _mm_sub_epi32(step1[15], step2[14]);
        ...
        }
        {
          ...
          u[0] = _mm_unpacklo_epi32(step2[17], step2[30]);
          u[1] = _mm_unpackhi_epi32(step2[17], step2[30]);
          u[2] = _mm_unpacklo_epi32(step2[18], step2[29]);
          u[3] = _mm_unpackhi_epi32(step2[18], step2[29]);
          u[4] = _mm_unpacklo_epi32(step2[21], step2[26]);
          u[5] = _mm_unpackhi_epi32(step2[21], step2[26]);
          u[6] = _mm_unpacklo_epi32(step2[22], step2[25]);
          u[7] = _mm_unpackhi_epi32(step2[22], step2[25]);

          v[0] = k_madd_epi32(u[0], k32_m04_p28);
          v[1] = k_madd_epi32(u[1], k32_m04_p28);
          v[2] = k_madd_epi32(u[2], k32_m28_m04);
          v[3] = k_madd_epi32(u[3], k32_m28_m04);
          v[4] = k_madd_epi32(u[4], k32_m20_p12);
          v[5] = k_madd_epi32(u[5], k32_m20_p12);
          v[6] = k_madd_epi32(u[6], k32_m12_m20);
          v[7] = k_madd_epi32(u[7], k32_m12_m20);
          v[8] = k_madd_epi32(u[6], k32_m20_p12);
          v[9] = k_madd_epi32(u[7], k32_m20_p12);
          v[10] = k_madd_epi32(u[4], k32_p12_p20);
          v[11] = k_madd_epi32(u[5], k32_p12_p20);
          v[12] = k_madd_epi32(u[2], k32_m04_p28);
          v[13] = k_madd_epi32(u[3], k32_m04_p28);
          v[14] = k_madd_epi32(u[0], k32_p28_p04);
          v[15] = k_madd_epi32(u[1], k32_p28_p04);
#if DCT_HIGH_BIT_DEPTH
          overflow = k_check_epi32_overflow_16(
              &v[0], &v[1], &v[2], &v[3], &v[4], &v[5], &v[6], &v[7], &v[8],
              &v[9], &v[10], &v[11], &v[12], &v[13], &v[14], &v[15], &kZero);
          ...
          step3[17] = _mm_srai_epi32(v[0], DCT_CONST_BITS);
          step3[18] = _mm_srai_epi32(v[1], DCT_CONST_BITS);
          step3[21] = _mm_srai_epi32(v[2], DCT_CONST_BITS);
          step3[22] = _mm_srai_epi32(v[3], DCT_CONST_BITS);
          step3[25] = _mm_srai_epi32(v[4], DCT_CONST_BITS);
          step3[26] = _mm_srai_epi32(v[5], DCT_CONST_BITS);
          step3[29] = _mm_srai_epi32(v[6], DCT_CONST_BITS);
          step3[30] = _mm_srai_epi32(v[7], DCT_CONST_BITS);
        }
        // stage 7
        {
          const __m128i k32_p30_p02 =
              pair_set_epi32(cospi_30_64, cospi_2_64);
          ...
          const __m128i k32_p06_p26 =
              pair_set_epi32(cospi_6_64, cospi_26_64);
          ...
          u[0] = _mm_unpacklo_epi32(step3[8], step3[15]);
          u[1] = _mm_unpackhi_epi32(step3[8], step3[15]);
          u[2] = _mm_unpacklo_epi32(step3[9], step3[14]);
          u[3] = _mm_unpackhi_epi32(step3[9], step3[14]);
          u[4] = _mm_unpacklo_epi32(step3[10], step3[13]);
          u[5] = _mm_unpackhi_epi32(step3[10], step3[13]);
          u[6] = _mm_unpacklo_epi32(step3[11], step3[12]);
          u[7] = _mm_unpackhi_epi32(step3[11], step3[12]);

          v[0] = k_madd_epi32(u[0], k32_p30_p02);
          v[1] = k_madd_epi32(u[1], k32_p30_p02);
          v[2] = k_madd_epi32(u[2], k32_p14_p18);
          v[3] = k_madd_epi32(u[3], k32_p14_p18);
          v[4] = k_madd_epi32(u[4], k32_p22_p10);
          v[5] = k_madd_epi32(u[5], k32_p22_p10);
          v[6] = k_madd_epi32(u[6], k32_p06_p26);
          v[7] = k_madd_epi32(u[7], k32_p06_p26);
          v[8] = k_madd_epi32(u[6], k32_m26_p06);
          v[9] = k_madd_epi32(u[7], k32_m26_p06);
          v[10] = k_madd_epi32(u[4], k32_m10_p22);
          v[11] = k_madd_epi32(u[5], k32_m10_p22);
          v[12] = k_madd_epi32(u[2], k32_m18_p14);
          v[13] = k_madd_epi32(u[3], k32_m18_p14);
          v[14] = k_madd_epi32(u[0], k32_m02_p30);
          v[15] = k_madd_epi32(u[1], k32_m02_p30);
#if DCT_HIGH_BIT_DEPTH
          overflow = k_check_epi32_overflow_16(
              &v[0], &v[1], &v[2], &v[3], &v[4], &v[5], &v[6], &v[7], &v[8],
              &v[9], &v[10], &v[11], &v[12], &v[13], &v[14], &v[15], &kZero);
          ...
          v[0] = _mm_cmpgt_epi32(kZero, u[0]);
          v[1] = _mm_cmpgt_epi32(kZero, u[1]);
          v[2] = _mm_cmpgt_epi32(kZero, u[2]);
          v[3] = _mm_cmpgt_epi32(kZero, u[3]);
          v[4] = _mm_cmpgt_epi32(kZero, u[4]);
          v[5] = _mm_cmpgt_epi32(kZero, u[5]);
          v[6] = _mm_cmpgt_epi32(kZero, u[6]);
          v[7] = _mm_cmpgt_epi32(kZero, u[7]);
          ...
          out_ptr[2] = _mm_packs_epi32(u[0], u[2]);
          out_ptr[10] = _mm_packs_epi32(u[1], u[3]);
          out_ptr[6] = _mm_packs_epi32(u[4], u[6]);
          out_ptr[14] = _mm_packs_epi32(u[5], u[7]);
#if DCT_HIGH_BIT_DEPTH
          overflow =
              check_epi16_overflow_x4(&out_ptr[2], &out_ptr[10], &out_ptr[6], &out_ptr[14]);
          if (overflow) {
            HIGH_FDCT32x32_2D_ROWS_C(intermediate, output_org);
            return;
          }
        ...
        {
          step1[16] = _mm_add_epi32(step3[17], step2[16]);
          step1[17] = _mm_sub_epi32(step2[16], step3[17]);
          step1[18] = _mm_sub_epi32(step2[19], step3[18]);
          step1[19] = _mm_add_epi32(step3[18], step2[19]);
          step1[20] = _mm_add_epi32(step3[21], step2[20]);
          step1[21] = _mm_sub_epi32(step2[20], step3[21]);
          step1[22] = _mm_sub_epi32(step2[23], step3[22]);
          step1[23] = _mm_add_epi32(step3[22], step2[23]);
          step1[24] = _mm_add_epi32(step3[25], step2[24]);
          step1[25] = _mm_sub_epi32(step2[24], step3[25]);
          step1[26] = _mm_sub_epi32(step2[27], step3[26]);
          step1[27] = _mm_add_epi32(step3[26], step2[27]);
          step1[28] = _mm_add_epi32(step3[29], step2[28]);
          step1[29] = _mm_sub_epi32(step2[28], step3[29]);
          step1[30] = _mm_sub_epi32(step2[31], step3[30]);
          step1[31] = _mm_add_epi32(step3[30], step2[31]);
        }
        // stage 8
        {
          const __m128i k32_p31_p01 =
              pair_set_epi32(cospi_31_64, cospi_1_64);
          const __m128i k32_p15_p17 =
              pair_set_epi32(cospi_15_64, cospi_17_64);
          const __m128i k32_p23_p09 =
              pair_set_epi32(cospi_23_64, cospi_9_64);
          const __m128i k32_p07_p25 =
              pair_set_epi32(cospi_7_64, cospi_25_64);
          ...
          u[0] = _mm_unpacklo_epi32(step1[16], step1[31]);
          u[1] = _mm_unpackhi_epi32(step1[16], step1[31]);
          u[2] = _mm_unpacklo_epi32(step1[17], step1[30]);
          u[3] = _mm_unpackhi_epi32(step1[17], step1[30]);
          u[4] = _mm_unpacklo_epi32(step1[18], step1[29]);
          u[5] = _mm_unpackhi_epi32(step1[18], step1[29]);
          u[6] = _mm_unpacklo_epi32(step1[19], step1[28]);
          u[7] = _mm_unpackhi_epi32(step1[19], step1[28]);

          v[0] = k_madd_epi32(u[0], k32_p31_p01);
          v[1] = k_madd_epi32(u[1], k32_p31_p01);
          v[2] = k_madd_epi32(u[2], k32_p15_p17);
          v[3] = k_madd_epi32(u[3], k32_p15_p17);
          v[4] = k_madd_epi32(u[4], k32_p23_p09);
          v[5] = k_madd_epi32(u[5], k32_p23_p09);
          v[6] = k_madd_epi32(u[6], k32_p07_p25);
          v[7] = k_madd_epi32(u[7], k32_p07_p25);
          v[8] = k_madd_epi32(u[6], k32_m25_p07);
          v[9] = k_madd_epi32(u[7], k32_m25_p07);
          v[10] = k_madd_epi32(u[4], k32_m09_p23);
          v[11] = k_madd_epi32(u[5], k32_m09_p23);
          v[12] = k_madd_epi32(u[2], k32_m17_p15);
          v[13] = k_madd_epi32(u[3], k32_m17_p15);
          v[14] = k_madd_epi32(u[0], k32_m01_p31);
          v[15] = k_madd_epi32(u[1], k32_m01_p31);
#if DCT_HIGH_BIT_DEPTH
          overflow = k_check_epi32_overflow_16(
              &v[0], &v[1], &v[2], &v[3], &v[4], &v[5], &v[6], &v[7], &v[8],
              &v[9], &v[10], &v[11], &v[12], &v[13], &v[14], &v[15], &kZero);
          ...
          out_ptr[1] = _mm_packs_epi32(u[0], u[2]);
          out_ptr[9] = _mm_packs_epi32(u[1], u[3]);
          out_ptr[7] = _mm_packs_epi32(u[4], u[6]);
          out_ptr[15] = _mm_packs_epi32(u[5], u[7]);
#if DCT_HIGH_BIT_DEPTH
          overflow =
              check_epi16_overflow_x4(&out_ptr[1], &out_ptr[9], &out_ptr[7], &out_ptr[15]);
          if (overflow) {
            HIGH_FDCT32x32_2D_ROWS_C(intermediate, output_org);
            return;
          }
        ...
        {
          const __m128i k32_p27_p05 =
              pair_set_epi32(cospi_27_64, cospi_5_64);
          ...
          const __m128i k32_p03_p29 =
              pair_set_epi32(cospi_3_64, cospi_29_64);
          ...
          u[0] = _mm_unpacklo_epi32(step1[20], step1[27]);
          u[1] = _mm_unpackhi_epi32(step1[20], step1[27]);
          u[2] = _mm_unpacklo_epi32(step1[21], step1[26]);
          u[3] = _mm_unpackhi_epi32(step1[21], step1[26]);
          u[4] = _mm_unpacklo_epi32(step1[22], step1[25]);
          u[5] = _mm_unpackhi_epi32(step1[22], step1[25]);
          u[6] = _mm_unpacklo_epi32(step1[23], step1[24]);
          u[7] = _mm_unpackhi_epi32(step1[23], step1[24]);

          v[0] = k_madd_epi32(u[0], k32_p27_p05);
          v[1] = k_madd_epi32(u[1], k32_p27_p05);
          v[2] = k_madd_epi32(u[2], k32_p11_p21);
          v[3] = k_madd_epi32(u[3], k32_p11_p21);
          v[4] = k_madd_epi32(u[4], k32_p19_p13);
          v[5] = k_madd_epi32(u[5], k32_p19_p13);
          v[6] = k_madd_epi32(u[6], k32_p03_p29);
          v[7] = k_madd_epi32(u[7], k32_p03_p29);
          v[8] = k_madd_epi32(u[6], k32_m29_p03);
          v[17] = k_madd_epi32(u[7], k32_m29_p03);
          v[10] = k_madd_epi32(u[4], k32_m13_p19);
          v[11] = k_madd_epi32(u[5], k32_m13_p19);
          v[12] = k_madd_epi32(u[2], k32_m21_p11);
          v[13] = k_madd_epi32(u[3], k32_m21_p11);
          v[14] = k_madd_epi32(u[0], k32_m05_p27);
          v[15] = k_madd_epi32(u[1], k32_m05_p27);
#if DCT_HIGH_BIT_DEPTH
          overflow = k_check_epi32_overflow_16(
              &v[0], &v[1], &v[2], &v[3], &v[4], &v[5], &v[6], &v[7], &v[8],
              &v[9], &v[10], &v[11], &v[12], &v[13], &v[14], &v[15], &kZero);
          ...
          out_ptr[5] = _mm_packs_epi32(u[0], u[2]);
          out_ptr[13] = _mm_packs_epi32(u[1], u[3]);
          out_ptr[3] = _mm_packs_epi32(u[4], u[6]);
          out_ptr[11] = _mm_packs_epi32(u[5], u[7]);
#if DCT_HIGH_BIT_DEPTH
          overflow =
              check_epi16_overflow_x4(&out_ptr[5], &out_ptr[13], &out_ptr[3], &out_ptr[11]);
          if (overflow) {
            HIGH_FDCT32x32_2D_ROWS_C(intermediate, output_org);
            return;
          }
      ...
      // Transpose the results, do it as four 4x16 transposes.
      {
        ...
        {
          int16_t *output0 = &intermediate[(column_start + 4*interleave) * 32];
          tran_low_t *output1 = &output_org[(column_start + 4*interleave) * 32];
          for (transpose_block = 0; transpose_block < 2; ++transpose_block) {
            ...
            if (pass == 0) {
              ...
              _mm_storeu_si128((__m128i *)(output0 + 0 * 32 + 8), tr2_4);
              _mm_storeu_si128((__m128i *)(output0 + 1 * 32 + 8), tr2_5);
              _mm_storeu_si128((__m128i *)(output0 + 2 * 32 + 8), tr2_6);
              _mm_storeu_si128((__m128i *)(output0 + 3 * 32 + 8), tr2_7);
              // Process next 8x16
              output0 += 16;
            } else {
              ...
              storeu_output(&tr2_4, (output1 + 0 * 32 + 8));
              storeu_output(&tr2_5, (output1 + 1 * 32 + 8));
              storeu_output(&tr2_6, (output1 + 2 * 32 + 8));
              storeu_output(&tr2_7, (output1 + 3 * 32 + 8));
              // Process next 8x16
              output1 += 16;
            }
            this_out += 8;
