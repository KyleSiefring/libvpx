    ...
    for (column_start = 0; column_start < 32; column_start += 16) {
      ...
      if (pass == 0) {
        ...
        }
        {
          ...
          out_ptr[8] = _mm256_packs_epi32(u[4], u[6]);
        }
        {
          const __m256i k32_m08_p24 =
              pair256_set_epi32(-cospi_8_64, cospi_24_64);
        ...
        // stage 6
        {
          ...
          out_ptr[12] = _mm256_packs_epi32(u[4], u[6]);
        }
        {
        ...
        // stage 7
        {
          ...
          out_ptr[10] = _mm256_packs_epi32(u[4], u[6]);
          out_ptr[6] = _mm256_packs_epi32(u[8], u[10]);
          out_ptr[14] = _mm256_packs_epi32(u[12], u[14]);
        }
        {
        ...
        // stage 8
        {
          ...
          out_ptr[9] = _mm256_packs_epi32(u[4], u[6]);
          out_ptr[7] = _mm256_packs_epi32(u[8], u[10]);
          out_ptr[15] = _mm256_packs_epi32(u[12], u[14]);
        }
        {
          ...
          out_ptr[13] = _mm256_packs_epi32(u[4], u[6]);
          out_ptr[3] = _mm256_packs_epi32(u[8], u[10]);
          out_ptr[11] = _mm256_packs_epi32(u[12], u[14]);
        }
        out_ptr+=16;
        if (i == 0)
        {
...
#endif
      {
        ...
        for (transpose_block = 0; transpose_block < 4; ++transpose_block) {
          ...
          __m256i tr2_2 = _mm256_unpacklo_epi64(tr1_2, tr1_6);
          __m256i tr2_3 = _mm256_unpackhi_epi64(tr1_2, tr1_6);
          __m256i tr2_4 = _mm256_unpacklo_epi64(tr1_1, tr1_5);//+16
          __m256i tr2_5 = _mm256_unpackhi_epi64(tr1_1, tr1_5);//+16
          __m256i tr2_6 = _mm256_unpacklo_epi64(tr1_3, tr1_7);//+16
          __m256i tr2_7 = _mm256_unpackhi_epi64(tr1_3, tr1_7);//+16
          // 00 20 40 60 80 100 120 140 08 28 48 68 88 108 128 148
          // 01 21 41 61 81 101 121 141 09 29 49 69 89 109 129 149
          // 02 22 42 62 82 102 122 142 10 30 50 70 90 110 130 150
          // 03 23 43 63 83 103 123 143 11 31 51 71 91 101 131 151
          ...
          _mm_storeu_si128((__m128i *)(output_currStep + 3 * 32),
                           _mm256_castsi256_si128(tr2_3));
          _mm_storeu_si128((__m128i *)(output_currStep + 0 * 32 + 16),
                           _mm256_castsi256_si128(tr2_4));
          _mm_storeu_si128((__m128i *)(output_currStep + 1 * 32 + 16),
                           _mm256_castsi256_si128(tr2_5));
          _mm_storeu_si128((__m128i *)(output_currStep + 2 * 32 + 16),
                           _mm256_castsi256_si128(tr2_6));
          _mm_storeu_si128((__m128i *)(output_currStep + 3 * 32 + 16),
                           _mm256_castsi256_si128(tr2_7));
          ...
          _mm_storeu_si128((__m128i *)(output_nextStep + 3 * 32),
                           _mm256_extractf128_si256(tr2_3, 1));
          _mm_storeu_si128((__m128i *)(output_nextStep + 0 * 32 + 16),
                           _mm256_extractf128_si256(tr2_4, 1));
          _mm_storeu_si128((__m128i *)(output_nextStep + 1 * 32 + 16),
                           _mm256_extractf128_si256(tr2_5, 1));
          _mm_storeu_si128((__m128i *)(output_nextStep + 2 * 32 + 16),
                           _mm256_extractf128_si256(tr2_6, 1));
          _mm_storeu_si128((__m128i *)(output_nextStep + 3 * 32 + 16),
                           _mm256_extractf128_si256(tr2_7, 1));
          // Process next 8x8
          if (transpose_block == 1) {
            output_currStep += 4*32-8;
            output_nextStep += 4*32-8;
          } else {
            output_currStep += 8;
            output_nextStep += 8;
          }
